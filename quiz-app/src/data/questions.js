// Data soal quiz - 3 kategori, masing-masing 10 soal
export const questions = {
  umum: [
    ...
    { id: 10, question: "Siapa penulis lagu Indonesia Raya?", options: ["WR Supratman", "Ismail Marzuki", "Chairil Anwar", "Raden Adjeng Kartini"], answer: "WR Supratman", category: "umum" },
  ],
  sains: [
    { id: 11, question: "Apa simbol kimia untuk Air?", options: ["CO2", "H2O", "O2", "NaCl"], answer: "H2O", category: "sains" },
    { id: 12, question: "Planet terdekat dengan Matahari adalah?", options: ["Venus", "Bumi", "Mars", "Merkurius"], answer: "Merkurius", category: "sains" },
    { id: 13, question: "Berapa kecepatan cahaya dalam vakum (km/s)?", options: ["150.000", "200.000", "300.000", "400.000"], answer: "300.000", category: "sains" },
    ...
    { id: 16, question: "Berapa jumlah kromosom normal manusia?", options: ["23", "44", "46", "48"], answer: "46", category: "sains" },
    { id: 17, question: "Apa nama lapisan terluar bumi?", options: ["Mantel", "Inti", "Kerak", "Litosfer"], answer: "Kerak", category: "sains" },
    ...
    { id: 19, question: "Apa satuan kekuatan gempa bumi?", options: ["Desibel", "Skala Richter", "Knot", "Pascal"], answer: "Skala Richter", category: "sains" },
  ...
  teknologi: [
    ...
    { id: 23, question: "Apa kepanjangan dari CPU?", options: ["Central Processing Unit", "Computer Personal Unit", "Central Program Utility", "Core Processing Unit"], answer: "Central Processing Unit", category: "teknologi" },
    { id: 24, question: "Bahasa pemrograman yang dibuat oleh Guido van Rossum adalah?", options: ["Java", "C++", "Python", "Ruby"], answer: "Python", category: "teknologi" },
    ...
    { id: 29, question: "Apa kepanjangan dari URL?", options: ["Uniform Resource Locator", "Universal Resource Link", "Uniform Reference Locator", "User Resource Locator"], answer: "Uniform Resource Locator", category: "teknologi" },
...
export const categoryInfo = {
  umum: { label: "Pengetahuan Umum", description: "Soal tentang Indonesia & dunia", color: "#6366f1", emoji: "??" },
  sains: { label: "Sains & IPA", description: "Fisika, kimia, biologi, astronomi", color: "#10b981", emoji: "??" },
  teknologi: { label: "Teknologi & IT", description: "Komputer, pemrograman, internet", color: "#f59e0b", emoji: "??" },
};
