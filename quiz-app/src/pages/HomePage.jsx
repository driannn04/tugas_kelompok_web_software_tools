  ...
  return (
    <div className="home-wrapper">
      <div className="home-hero">
        ...
        <h1>Halo, <span className="highlight">{currentUser?.username}</span>! ??</h1>
        <p>Pilih kategori kuis yang ingin kamu mainkan. Uji pengetahuanmu dan raih skor tertinggi!</p>
      </div>

      <div className="categories-grid">
        {Object.entries(categoryInfo).map(([key, cat]) => (
          <button key={key} className="category-card" onClick={() => navigate(`/quiz/${key}`)}
